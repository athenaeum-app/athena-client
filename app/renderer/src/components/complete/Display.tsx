...
const Display: Component = () => (
    <div class="relative flex h-full w-full flex-col items-center justify-between gap-2 overflow-y-auto transition-all duration-100 lg:flex-row">
        ...
        <div class="order-3 h-full w-full lg:order-2 lg:max-w-4xl">
            <Feed />
        </div>
        <div class="z-10 order-2 hidden h-full w-full text-center md:block lg:order-3 lg:max-w-xs lg:text-left">
            <FilterBar />
        </div>
    </div>
)
